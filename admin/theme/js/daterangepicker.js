...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.append_to == 'string'){
            this.parentElement = $(options.append_to);
        }
        ...
        if (hasOptions) {
            if (typeof options.append_to == 'string'){
                this.container = $(DRPTemplate).appendTo(options.append_to);
            } else {
        ...
        if (hasOptions) {
            ...
            if (typeof options.cssTop == 'string')
                this.cssTop = options.cssTop;
                
            if (typeof options.cssLeft == 'string')
                this.cssLeft = options.cssLeft;
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            } else if (this.opens == 'custom'){
                
                var scrolled = this.parentElement.scrollTop();
                
                this.container.css({
                    top: scrolled + this.element.position().top + this.element.outerHeight(),
