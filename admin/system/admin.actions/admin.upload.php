...
$targetDir = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'uploads';
//$targetDir = 'uploads';
...
// Get more file info and update target url, create a directory if doesn't exist
...
die('{"jsonrpc" : "2.0", "fileName" : "' . $fileName . '", "fileType" : "' . $fileType . '", "fileYear" : "' . $fileYear . '", "fileMonth" : "' . $fileMonth . '", "id" : "id"}');
//die('{"jsonrpc" : "2.0", "result" : "' . $fileName . '", "full_result" : "", "id" : "id"}');
