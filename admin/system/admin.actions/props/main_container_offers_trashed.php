                ...
                <tbody>
                    ...
                    <tr id="<?php echo $offer['id']; ?>">
                        ...
                        <td class="actions">
                            ...
                            <button title="Renew offer" class="btn" onclick="hide_content_row('<?php echo $offer['id']; ?>', 'renew_offer')"><i class="icon-retweet"></i></button>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
...
$(function () { 
    ...
    function send_search(){
        ...
        if (!search_term){
            ...
            $("#offer_search").attr('href', '/admin/interface/contents/offers_trashed/0_10_search-simple_' + search_term_encoded + '/');
...
function duplicate_offer_row(id){
    var offer_title = $("tr#" + id + " td").first().html();
